...
//***** SHT75 okumasýný beklemek için fonksiyon *****
...
//***** SHT75 iletiþimini sýfýrlama iþlevi *****
...
//***** SHT75 sýcaklýðýný ölçme fonksiyonu *****
...
//***** SHT75 RH(nem)'yi ölçme fonksiyonu *****
...
//***** SHT75 sýcaklýðý ve RH'yi ölçen ve hesaplayan fonksiyon*****
...
//***** SHT75'i açýlýþta baþlatma iþlevi *****
...
while(1)
 {
  ...
  printf(lcd_putc,"\nRH   : %3.1f %%   ", truehumid);
  delay_ms(500);        //sensörün kendi kendine ýsýnmasýný önlemek için okuma arasýnda 500 ms gecikme
 }
}
